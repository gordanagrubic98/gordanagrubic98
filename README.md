...
- **Testing Tools:** TestNG, Maven, API Testing.
- **Languages:** Java (Deep dive into OOP: Polymorphism, Abstraction, Exception Handling).

**Manual Testing & Quality Management:**
- **Strategy:** Test Plans, Scenarios, and comprehensive Test Case design.
- **Reporting:** Expert bug reporting and lifecycle management in **Jira**.
- **Methodologies:** Agile/Scrum, Waterfall, and QA Mindset.

**Data & Infrastructure:**
- **Databases:** SQL (Complex Joins, Nested Queries, Data Integrity).
- **Environment:** Git/GitHub, System Optimization.
